...
class attention1d(nn.Module):
    def __init__(self, in_planes, ratios, K, temperature, init_weight=True):
        ...
        if in_planes!=3:
            ...
            hidden_planes = K
        self.fc1 = nn.Conv1d(in_planes, hidden_planes, 1, bias=False) #kernel size = 1
...
if __name__ == '__main__':
    ...
    model = Dynamic_conv1d(in_planes=3, out_planes=16, kernel_size=3, ratio=0.25, padding=0,)
    # x = x.to('cuda:0')
    # model.to('cuda')
