...
# 数据集路径选择
path = 'MTS_dataset/AUSLAN/AUSLAN.mat'  # lenth=1140  input=136 channel=22 output=95
# path = 'MTS_dataset/CharacterTrajectories/CharacterTrajectories.mat'
# path = 'MTS_dataset/CMUsubject16/CMUsubject16.mat'  # lenth=29,29  input=580 channel=62 output=2
# path = 'MTS_dataset/ECG/ECG.mat'  # lenth=100  input=152 channel=2 output=2
# path = 'MTS_dataset\\JapaneseVowels\\JapaneseVowels.mat'  # lenth=270  input=29 channel=12 output=9
# path = 'MTS_dataset/Libras/Libras.mat'  # lenth=180  input=45 channel=2 output=15
# path = 'MTS_dataset/UWave/UWave.mat'  # lenth=4278  input=315 channel=3 output=8
# path = 'MTS_dataset/KickvsPunch/KickvsPunch.mat'  # lenth=10  input=841 channel=62 output=2
# path = 'MTS_dataset/NetFlow/NetFlow.mat'  # lenth=803  input=997 channel=4 output=只有1和13
# path = 'MTS_dataset\\ArabicDigits\\ArabicDigits.mat'  # lenth=6600  input=93 channel=13 output=10
# path = 'MTS_dataset/PEMS/PEMS.mat'
# path = 'MTS_dataset/Wafer/Wafer.mat'
# path = 'MTS_dataset\\WalkvsRun\\WalkvsRun.mat'
